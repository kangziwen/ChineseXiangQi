...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("ChineseQi");
#else
        glview = cocos2d::GLViewImpl::createWithRect("ChineseQi", Rect(0,0,960,640));
#endif
   ...
   bool run= ScriptingCore::getInstance()->runScript("main.js");
    log("run======%d",run);
    return true;
}
